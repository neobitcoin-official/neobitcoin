Contributing to NeoBitcoin Core
==================================

The NeoBitcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NeoBitcoin Core project, and is not to be
confused with overall NeoBitcoin Network Protocol consensus changes.

Whether a pull request is merged into NeoBitcoin Core rests with the project merge
...
Patches that change NeoBitcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the NeoBitcoin consensus, it must have been
...
The project leader is the release manager for each NeoBitcoin Core release.
