...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/neobitcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/neobitcoin-cli.cpp \
           src/neobitcoin-tx.cpp \
           src/neobitcoin.cpp \
           src/db.cpp \
           ...
           src/qt/neobitcoin.cpp \
           src/qt/neobitcoinstrings.cpp \
...
RESOURCES += src/qt/neobitcoin.qrc src/qt/neobitcoin_locale.qrc

TRANSLATIONS += src/qt/locale/neobitcoin_bg.ts \
                src/qt/locale/neobitcoin_de.ts \
                src/qt/locale/neobitcoin_en.ts \
                src/qt/locale/neobitcoin_es.ts \
                src/qt/locale/neobitcoin_fi.ts \
                src/qt/locale/neobitcoin_fr.ts \
                src/qt/locale/neobitcoin_it.ts \
                src/qt/locale/neobitcoin_ja.ts \
                src/qt/locale/neobitcoin_pl.ts \
                src/qt/locale/neobitcoin_pt.ts \
                src/qt/locale/neobitcoin_ru.ts \
                src/qt/locale/neobitcoin_sk.ts \
                src/qt/locale/neobitcoin_sv.ts \
                src/qt/locale/neobitcoin_vi.ts \
                src/qt/locale/neobitcoin_zh_CN.ts \
                src/qt/locale/neobitcoin_zh_TW.ts
