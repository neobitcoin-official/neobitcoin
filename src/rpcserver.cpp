...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NeoBitcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "NeoBitcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NeoBitcoin features */
        {"neobitcoin", "masternode", &masternode, true, true, false},
        {"neobitcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"neobitcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"neobitcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"neobitcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"neobitcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"neobitcoin", "startmasternode", &startmasternode, true, true, false},
        {"neobitcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"neobitcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"neobitcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"neobitcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"neobitcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"neobitcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"neobitcoin", "mnbudget", &mnbudget, true, true, false},
        {"neobitcoin", "preparebudget", &preparebudget, true, true, false},
        {"neobitcoin", "submitbudget", &submitbudget, true, true, false},
        {"neobitcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"neobitcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"neobitcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"neobitcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"neobitcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"neobitcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"neobitcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"neobitcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"neobitcoin", "mnsync", &mnsync, true, true, false},
        {"neobitcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> neobitcoin-cli " + methodname + " " + args + "\n";
}
