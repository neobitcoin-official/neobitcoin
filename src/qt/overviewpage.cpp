...
#define NEWS_URL "https://rfc.neobitcoin.org/category/news/feed/"
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::NBTC)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount nbtcAvailableBalance = balance - immatureBalance - nLockedBalance;

    // NBTC Watch-Only Balance
    CAmount nTotalWatchBalance = watchOnlyBalance + watchUnconfBalance;
    CAmount nAvailableWatchBalance = watchOnlyBalance - watchImmatureBalance - nWatchOnlyLockedBalance;

    // NBTC labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, nbtcAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // NBTC Available
    bool showNBTCAvailable = settingShowAllBalances || nbtcAvailableBalance != nTotalBalance;
    bool showWatchOnlyNBTCAvailable = showNBTCAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showNBTCAvailable || showWatchOnlyNBTCAvailable);
    ui->labelBalance->setVisible(showNBTCAvailable || showWatchOnlyNBTCAvailable);
    ui->labelWatchAvailable->setVisible(showNBTCAvailable && showWatchOnly);

    // NBTC Pending
    bool showNBTCPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyNBTCPending = showNBTCPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showNBTCPending || showWatchOnlyNBTCPending);
    ui->labelUnconfirmed->setVisible(showNBTCPending || showWatchOnlyNBTCPending);
    ui->labelWatchPending->setVisible(showNBTCPending && showWatchOnly);
    ...
    // NBTC Locked
    bool showNBTCLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyNBTCLocked = showNBTCLocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showNBTCLocked || showWatchOnlyNBTCLocked);
    ui->labelLockedBalance->setVisible(showNBTCLocked || showWatchOnlyNBTCLocked);
    ui->labelWatchLocked->setVisible(showNBTCLocked && showWatchOnly);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("NBTC")
    updateDisplayUnit();
}
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinks7->setText("NBTC Merchants");

    ui->labelLinksUrl1->setText("<a href=\"https://www.neobitcoin.org\">https://www.neobitcoin.org</a>");
    ui->labelLinksUrl2->setText("<a href=\"https://neobitcoin.org/go/whitepaper.pdf\">https://neobitcoin.org/go/whitepaper.pdf</a>");
    ui->labelLinksUrl3->setText("<a href=\"http://explorer.neobitcoin.online\">http://explorer.neobitcoin.online</a>");
    ui->labelLinksUrl4->setText("<a href=\"https://neobitcoin.org/go/discord\">https://neobitcoin.org/go/discord</a>");
    ui->labelLinksUrl5->setText("<a href=\"https://neobitcoin.org/go/twitter\">https://neobitcoin.org/go/twitter</a>");
    ui->labelLinksUrl6->setText("<a href=\"https://github.com/neobitcoin-official/neobitcoin\">https://github.com/neobitcoin-official/neobitcoin</a>");
}
