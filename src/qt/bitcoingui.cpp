                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NeoBitcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NBTC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and neobitcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NeoBitcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about NeoBitcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NeoBitcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NBTC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NBTC addresses"));
    ...
    openAction->setStatusTip(tr("Open a neobitcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NeoBitcoin Core help message to get a list with possible NeoBitcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NeoBitcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NeoBitcoin network", "", count));
}
...
{
    QString strTitle = tr("NeoBitcoin Core"); // default title
