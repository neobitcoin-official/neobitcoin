...
/** Utility functions used by the NeoBitcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render NBTC addresses in monospace font
...
// Parse "neobitcoin:" URI into recipient object, return true on successful parsing
