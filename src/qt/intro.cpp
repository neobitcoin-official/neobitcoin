...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NeoBitcoin Core"),
     ...
     * override -datadir in the neobitcoin.conf file in the default data directory
     * (to be consistent with neobitcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
