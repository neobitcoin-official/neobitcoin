...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NeoBitcoin Core neobitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  neobitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded neobitcoin transaction") + "\n" +
                               "  neobitcoin-tx [options] -create [commands]   " + _("Create hex-encoded neobitcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded neobitcoin transaction
