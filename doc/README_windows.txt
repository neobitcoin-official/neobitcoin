...
Intro
-----
NeoBitcoin (NBTC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. NeoBitcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run neobitcoin-qt.exe.

NeoBitcoin Core is the original NeoBitcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of NeoBitcoin transactions;
