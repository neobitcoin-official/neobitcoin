...
*Setup instructions for a gitian build of NeoBitcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the NeoBitcoin
...
- [Building NeoBitcoin](#building-neobitcoin)
...
Clone the git repositories for neobitcoin and gitian and then checkout the neobitcoin version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the neobitcoin repository
...
To build NeoBitcoin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the neobitcoin repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/neobitcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/neobitcoin/neobitcoin
...
For example:
```bash
URL=https://github.com/konez2k/neobitcoin.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit neobitcoin=${COMMIT} --url neobitcoin=${URL} ../neobitcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit neobitcoin=${COMMIT} --url neobitcoin=${URL} ../neobitcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit neobitcoin=${COMMIT} --url neobitcoin=${URL} ../neobitcoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/neobitcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/neobitcoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/neobitcoin-build.assert
```
...
[neobitcoin/gitian.sigs](https://github.com/neobitcoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
