...
In order to support loading of multiple wallets in neobitcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is neobitcoin.cpp.
...
Changes to neobitcoin.cpp
----------------------
neobitcoin.cpp is the entry point into neobitcoin-qt, and as such, will require some minor modifications to provide hooks for
