...
#   c) node1 mines 32 blocks, so now node 0 has 500000NBTC, node 1 has 4250NBTC, node2 has none.
#   d) node0 sends 601 NBTC to node2, in two transactions (301 NBTC, then 300 NBTC).
